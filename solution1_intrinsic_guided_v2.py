...
t_level = 20
max_iterations = 10
guidance_scale = 0.1  # constraint guidance strength
BAD_X_THRESH = 0.20
BAD_Y_THRESH = 0.30
...
np.save('/blue/iruchkin/aj.byreddy/tea_lab/results_solution1_intrinsic_guided_v2.npy', results)
print("✅ Results saved!")

print("\n" + "="*65)
print("SOLUTION #1 GUIDED v2 — Results")
print("="*65)
